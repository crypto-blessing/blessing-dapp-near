...
const deleteKeyTool = async () => {
  ...
  const account = await near.account("nft.cryptoblessing.testnet");
  ...
  let publicKeyToDelete = "ed25519:B1RgRQpvyjD1eAfaDEKfjaAmbNWk3zEWAS9QqUR3wmx3"; // pub your public key here
